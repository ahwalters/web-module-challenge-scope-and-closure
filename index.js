...
/*Task 1: counterMaker()
  ...
  Counter 1 is a function stored within a variable whereas counter2 is a function.
  
  2. Which of the two uses a closure? How can you tell?
  counter uses a closure because it is a function that is referencing external variables.
...
function getInningScore(inning) {
    let scoreHome = inning();
    let scoreAway = inning();
    const scores = {
      Home: scoreHome,
      Away: scoreAway
    }
